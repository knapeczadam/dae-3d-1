...
Hey there, fellow DAE student, 3D enthusiast, or digital artisan 👋  
Welcome to my **3D 1** repository — a showcase of my work created during the **second semester (2023)** at **Howest DAE**.
...
> ⚠️ Keep in mind: this project was created during my first steps into 3D modeling.  
> Expect rough edges, topology crimes, and the occasional UV disaster.  
> It’s all part of the learning curve — think of this as a milestone on the road to better models.  
...
### 🔗 View the project on Sketchfab:
[🌾 DAE Diorama – Small Farm](https://sketchfab.com/3d-models/dae-diorama-small-farm-b8f5616338534fdbb986ae329e8fbfd2)

---

## 🧠 Final Thoughts

3D1 was my introduction to professional 3D workflows — from raw geometry to rendered storytelling.  
It taught me how to translate references into clean topology, balanced textures, and believable lighting.  

If you’re starting out: block out first, keep it simple, and iterate — clarity beats complexity 🌿  
